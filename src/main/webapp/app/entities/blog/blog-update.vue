  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="myApp.blog.home.createOrEditLabel" data-cy="BlogCreateUpdateHeading" v-text="$t('myApp.blog.home.createOrEditLabel')">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.blog.name')" for="blog-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.blog.handle')" for="blog-handle">Handle</label>
            <input
              type="text"
              class="form-control"
              name="handle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('myApp.blog.user')" for="blog-user">User</label>
